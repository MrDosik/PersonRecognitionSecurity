...
class PatchTransformer(nn.Module):
    ...
    def forward(self, adv_patch, lab_batch, img_size, do_rotate=True, rand_loc=True, roi=[0,0], color_change=False, TRAIN_LOCAL=False, local_index=-1):
        ...
        # ## 0~N: local / -1 : global
        # if(local_index == 0):
        #     adv_batch_unit = adv_batch[:,:,:, 0:225, 0:225].to(device)
        #     adv_batch_zeroes = torch.zeros(adv_batch.size()).to(device)
        #     adv_batch_zeroes[:,:,:, 0:225, 0:225] = adv_batch_unit
        #     adv_batch_unit = adv_batch_zeroes
        #     adv_batch = adv_batch_unit
        # elif(local_index == 1):
        #     adv_batch_unit = adv_batch[:,:,:, 0:225, 75:300].to(device)
        #     adv_batch_zeroes = torch.zeros(adv_batch.size()).to(device)
        #     adv_batch_zeroes[:,:,:, 0:225, 75:300] = adv_batch_unit
        #     adv_batch_unit = adv_batch_zeroes
        #     adv_batch = adv_batch_unit
        # elif(local_index == 2):
        #     adv_batch_unit = adv_batch[:,:,:, 75:300, 0:225].to(device)
        #     adv_batch_zeroes = torch.zeros(adv_batch.size()).to(device)
        #     adv_batch_zeroes[:,:,:, 75:300, 0:225] = adv_batch_unit
        #     adv_batch_unit = adv_batch_zeroes
        #     adv_batch = adv_batch_unit
        # elif(local_index == 3):
        #     adv_batch_unit = adv_batch[:,:,:, 75:300, 75:300].to(device)
        #     adv_batch_zeroes = torch.zeros(adv_batch.size()).to(device)
        ...
        if(local_index == 0):
            adv_batch_unit = adv_batch[:,:,:, 0:150, 0:150]
            adv_batch_zeroes = torch.zeros(adv_batch.size())
            adv_batch_zeroes[:,:,:, 0:150, 0:150] = adv_batch_unit
            adv_batch_unit = adv_batch_zeroes
            adv_batch = adv_batch_unit
        elif(local_index == 1):
            adv_batch_unit = adv_batch[:,:,:, 0:150, 150:300]
            adv_batch_zeroes = torch.zeros(adv_batch.size())
            adv_batch_zeroes[:,:,:, 0:150, 150:300] = adv_batch_unit
            adv_batch_unit = adv_batch_zeroes
            adv_batch = adv_batch_unit
        elif(local_index == 2):
            adv_batch_unit = adv_batch[:,:,:, 150:300, 0:150]
            adv_batch_zeroes = torch.zeros(adv_batch.size())
            adv_batch_zeroes[:,:,:, 150:300, 0:150] = adv_batch_unit
            adv_batch_unit = adv_batch_zeroes
            adv_batch = adv_batch_unit
        elif(local_index == 3):
            adv_batch_unit = adv_batch[:,:,:, 150:300, 150:300]
            adv_batch_zeroes = torch.zeros(adv_batch.size())
